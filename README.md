...
- <img src="https://img.shields.io/github/stars/Alex20Sas12/modelfit?style=social" height="17" align="texttop"/> [ModelFit](https://modelfit-eight.vercel.app/) - "can I run this LLM?" verdicts from measured GGUF file sizes (daily HF API sync), plus ranked best-LLM-for-X-VRAM pages and a CC-BY JSON API
